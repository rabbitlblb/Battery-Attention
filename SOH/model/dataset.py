...
def load(data_path, all_car_dict_path='../data/SOH_snippets/changed_files/all_car_dict.npz.npy', 
     ind_ood_car_dict_path='../data/SOH_snippets/changed_files/ind_odd_dict1.npz.npy',
